...
The main function of this regin is `src/net_processing.cpp:PeerManagerImpl::ProcessMessages(...)`, that is a giant conditional to handle the messages sent by the peers.