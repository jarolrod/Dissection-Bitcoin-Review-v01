...
If an specific IP was set, it will be the only one active outbound connection with that IP. +
If no "-connect" parameter was passed, all the outbound network connections will be initiate.
